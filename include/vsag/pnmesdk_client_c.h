 ...
 *
 * @param context: Description context of the database
 * @param query_vector:  Pointer to the target vector
 * @param query_vector_size: Size of the target vector
...
// hnsw search
int
database_context_hnsw_search(database_context* context, hnsw_search_opt* opt);
